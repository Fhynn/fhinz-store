...
try {
    ...
    // sendPaymentNotificationEmail($order);
...
function sendPaymentNotificationEmail($order) {
    // Implementation for sending email notification to admin
    // You can use PHPMailer or similar library here
    
    $to = 'admin@fhinzstore.com';
    $subject = 'New Payment Proof Uploaded - Order ' . $order['order_number'];
    $message = "
        New payment proof has been uploaded for order {$order['order_number']}.
        ...
        Please check the admin panel to verify the payment.
    ";
    
    $headers = 'From: noreply@fhinzstore.com' . "\r\n" .
               'Reply-To: support@fhinzstore.com' . "\r\n" .
